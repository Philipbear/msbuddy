...
def main():
    ...
    parser.add_argument('-details', type=bool, default=True, help='Whether to write detailed results.')
    ...
    parser.add_argument('-halogen', '-h', type=bool, default=False, help='Whether to consider halogen atoms FClBrI.')
    parser.add_argument('-parallel', '-p', type=bool, default=False, help='Whether to use parallel computing.')
    ...
    parser.add_argument('-batch_size', type=int, default=1000, help='Batch size. Default: 1000. A larger batch size needs more memory, but is faster.')
